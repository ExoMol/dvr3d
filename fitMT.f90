subroutine fit(v,r12,r32,alpha,npropin,xp)
      implicit real*8 (a-h,o-z)
!-----------------------------------------------------------------------
! PES for SO2 (singlet B2), MRCI-aug-cc-pVTZ, fitted with XY2.f90
! coded by Emil Zak, 6 Dec 2016
!-----------------------------------------------------------------------
! All quantities are expressed in Angstroms**k and cm^-1
